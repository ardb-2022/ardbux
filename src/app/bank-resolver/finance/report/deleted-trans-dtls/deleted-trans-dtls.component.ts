...
@Component({
  selector: 'app-deleted-trans-dtls',
  templateUrl: './deleted-trans-dtls.component.html',
  styleUrls: ['./deleted-trans-dtls.component.css'],
  providers:[ExportAsService]
  
})
export class DeletedTransDtlsComponent implements OnInit ,AfterViewInit{
...
// get the time as a string
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Voucher/PopulateTransScrollDel',dt).subscribe(data=>{console.log(data)
