...
@Component({
  selector: 'app-conso-loan-dc-nonfarm',
  templateUrl: './conso-loan-dc-nonfarm.component.html',
  styleUrls: ['./conso-loan-dc-nonfarm.component.css']
})
export class ConsoLoanDCNonfarmComponent {
  ...
  public SubmitReport() {
    this.comser.getDay(this.reportcriteria.controls.fromDate.value,this.reportcriteria.controls.toDate.value)
      ...
      this.svc.addUpdDel('Loan/PopulateDcStatementNFCONSO',dt).subscribe(data=>{console.log(data)
