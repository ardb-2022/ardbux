...
@Component({
  selector: 'app-borrower-insurance_report',
  templateUrl: './borrower-insurance_report.component.html',
  styleUrls: ['./borrower-insurance_report.component.css']
})
export class BorrowerInsuranceReportComponent implements OnInit ,AfterViewInit{
  ...
  displayedColumns: string[] = [
    'SL','cust_cd', 'cust_name', 'address', 'nominee', 
    'nom_relation', 'age', 'sex', 'loan_amt', 'insured_amt', 
    'premium_amt', 'remarks', 'receiving_dt'
  ];
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      var dt = {
        ...
        this.svc.addUpdDel('Loan/PopulateBorrowerInsuRep', dt).subscribe(data => {
          console.log(data)
  ...
  downloadexcel() {
    ...
    this.exportAsService.save(this.exportAsConfig, 'BorrowerInsuranceRep').subscribe(() => {
      // save started
      console.log("hello")
    });
  }
