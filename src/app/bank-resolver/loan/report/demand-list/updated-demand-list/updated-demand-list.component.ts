...
export class UpdatedDemandListComponent {
  ...
  selectedValue=''
  selectedValue1=''
  displayedColumns: string[] = ['acc_name','block_name','service_area_name','vill_name','loan_id','lf_no','party_name','phone','guardian_name','disb_dt','activity_cd','outstanding_prn','curr_prn','ovd_prn','curr_intt','ovd_intt','penal_intt','total'];
