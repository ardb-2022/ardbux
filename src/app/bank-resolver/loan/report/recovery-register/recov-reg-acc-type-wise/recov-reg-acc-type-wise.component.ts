...
export class RecovRegAccTypeWiseComponent implements OnInit{
  ...
  displayedColumns: string[] = ['acc_name','trans_dt','loan_id','cust_name','adv_prn_recov','curr_prn_recov','ovd_prn_recov','curr_intt_recov','ovd_intt_recov','penal_intt_recov','recov_amt','last_intt_calc_dt'];
  modalRef: BsModalRef;
  isOpenFromDp = false;
  isOpenToDp = false;
