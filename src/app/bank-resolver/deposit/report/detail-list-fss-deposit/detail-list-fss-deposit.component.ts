...
@Component({
  selector: 'app-detail-list-fss-deposit',
  templateUrl: './detail-list-fss-deposit.component.html',
  styleUrls: ['./detail-list-fss-deposit.component.css']
})
export class DetailListFssDepositComponent implements OnInit,AfterViewInit {
...
public onAccountTypeChange(): void {
  ...
  downloadexcel(){
    ...
    this.exportAsService.save(this.exportAsConfig, 'Detail_List_Flexi_Deposit').subscribe(() => {
      // save started
      console.log("hello")
    });
  }
