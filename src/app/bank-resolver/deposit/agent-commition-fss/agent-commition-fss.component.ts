...
@Component({
  selector: 'app-agent-commition-fss',
  templateUrl: './agent-commition-fss.component.html',
  styleUrls: ['./agent-commition-fss.component.css'],
  providers:[ExportAsService]
})
export class AgentCommitionFSSComponent {
  ...
  public SubmitReport() {
    ...
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Deposit/GetAgentCommissionNew',dt).subscribe(data=>{console.log(data)
