            ...
            if (selectedOperation.oprn_desc.toLocaleLowerCase() === 'close') {
              if (accTypeCd == 5 || accTypeCd == 5) {
                for (let i = 0; i < InvestmentTransactionsComponent.constitutionList.length; i++) {
                  if (InvestmentTransactionsComponent.constitutionList[i].constitution_cd == this.constCd && InvestmentTransactionsComponent.constitutionList[i].acc_type_cd == this.tddefAccTypCd) {
                    tdDefTransAndTranfer.acc_cd = InvestmentTransactionsComponent.constitutionList[i].acc_cd
        ...
        this.td_deftranstrfList.forEach(e => {
          if (e.amount != null) {
            ...
            if (selectedOperation.oprn_desc.toLocaleLowerCase() === 'interest payment') {
              ...
              //  { tdDefTransAndTranfer.acc_cd=InvestmentTransactionsComponent.constitutionList[i].intt_acc_cd
              //   console.log(tdDefTransAndTranfer.acc_cd)}
              // }
              // //debugger;
            }
